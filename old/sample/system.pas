...
procedure fpc_AnsiStr_Assign (Var DestS: Pointer; S2 : Pointer); [Public];  compilerproc;
...
Function fpc_get_input:PText;compilerproc; begin end;
Function fpc_get_output:PText;compilerproc; begin end;
...
function  fpc_ShortStr_To_AnsiStr (Const S2 : ShortString; cp : TSystemCodePage): RawByteString;
begin
end;
